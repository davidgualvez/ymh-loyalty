<nav class="navbar navbar-expand-lg navbar-light bg-light bs-mat2 mb-1">
	<a class="navbar-brand" href="https://www.yamahaclub.com.ph/">
		<img src="/assets/yclub_logo.png" alt="" class="img-fluid" style="height: 45px;  ">
	</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav ml-auto" id="nav-menu"> 
			{{-- <li class="nav-item" id="nav-home"> <!-- with active class -->
